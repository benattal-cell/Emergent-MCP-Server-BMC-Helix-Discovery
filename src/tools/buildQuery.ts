  ...
  return {
    discovery_build_query: {
      description: [
        ...
        "Cet outil N'EXÉCUTE PAS : il valide la syntaxe (clause-ordering, etc.) puis l'existence des kinds en taxonomy, et renvoie { dslQuery, ... }. Présenter dslQuery à l'utilisateur (qui peut la modifier), puis l'envoyer à discovery_execute_dsl.",
